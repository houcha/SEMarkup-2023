...
# See https://guide.allennlp.org/training-and-prediction#2 for guidance.
{
    ...
    "vocabulary": {
        "type": "extend",
        # Directory is set in train.sh script via --override argument.
    ...
    "trainer": {
        ...
        "optimizer": {
            "type": "adam",
            "lr": 1e-3, # Base (largest) learning rate.
            "parameter_groups": [
        ...
        "learning_rate_scheduler": {
            ...
            "decay_factor": 0.005, # We want BERT to be trained with learning rate 200 times smaller than heads.
